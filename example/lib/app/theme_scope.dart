...
///
/// The root app widget owns a `ValueNotifier<ThemeMode>`, rebuilds the `PlatformApp` when it ticks,
/// and publishes it through this scope via the app's `builder`. Any screen (e.g. the About tab) reads
/// it with [ThemeScope.of] and writes a new mode to flip the whole app's appearance, works identically
/// under both the Navigator and go_router entry points.
