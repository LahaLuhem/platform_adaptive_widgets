...
/// Detail page for the Dialogs & pickers category.
class DialogsDemoView extends StatelessWidget {
  ...
  Widget build(BuildContext context) => MVVM.builder(
    ...
    viewBuilder: (context, viewModel) => PlatformScaffold(
      appBarData: const PlatformAppBar(title: Text('Dialogs & pickers')),
      body: SafeArea(
          ...
          child: Column(
            ...
            children: [
              DemoCard(
                title: 'Dialog',
                description:
                    'A centered modal — showDialog on Android, showCupertinoDialog on iOS.',
                ...
                child: PlatformButton(
                  ...
                  child: ValueListenableBuilder(
                    ...
                    builder: (_, selectedDate, _) =>
                        Text(selectedDate?.toString() ?? 'Pick a date'),
                  ),
                ),
              ),
              DemoCard(
                ...
                child: PlatformButton(
                  ...
                  child: ValueListenableBuilder(
                    ...
                    builder: (_, selectedTime, _) =>
                        Text(selectedTime?.toString() ?? 'Pick a time'),
                  ),
                ),
              ),
            ],
