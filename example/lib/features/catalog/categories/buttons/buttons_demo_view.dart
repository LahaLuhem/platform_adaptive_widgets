...
/// Detail page for the Buttons category — the `PlatformButton` variants, the
/// icon constructor, and the disabled state.
class ButtonsDemoView extends StatelessWidget {
  ...
  Widget build(BuildContext context) => MVVM.builder(
    ...
    viewBuilder: (context, viewModel) => PlatformScaffold(
      appBarData: const PlatformAppBar(title: Text('Buttons')),
      body: SafeArea(
