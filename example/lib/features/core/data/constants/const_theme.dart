...
/// Branded theming for the demo. A single seed color drives a Material 3 light/dark scheme and a
/// matching Cupertino theme, so the app looks designed on both platforms and the About tab's
/// light/dark/system toggle has something to switch between.
abstract final class ConstTheme {
  ...
  /// Cupertino theme for the given [brightness]. Pass `null` to follow the device (used when the
  /// app's theme mode is `system`).
