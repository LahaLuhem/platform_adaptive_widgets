...
Future<DateTime?> showPlatformDatePicker({
  ...
  material: () => showDatePicker(
    ...
    initialEntryMode:
        materialDatePickerData?.initialEntryMode ?? MaterialDatePickerData.kDefaultInitialEntryMode,
    ...
    calendarDelegate:
        materialDatePickerData?.calendarDelegate ?? MaterialDatePickerData.kDefaultCalendarDelegate,
  ),
  cupertino: () async {
