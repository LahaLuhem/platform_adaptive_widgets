...
| `showRawDialog<T>()`                                               | `showDialog` (no surface wrap)                | `showCupertinoDialog` (no surface wrap)                                                                      | — (caller owns the surface)                           |
...
| `showRawModalBottomSheet<T>()`                                     | `showModalBottomSheet` (native Material)      | `showCupertinoModalPopup` (no surface wrap)                                                                  | `MaterialModalBottomSheetData`, `CupertinoModalPopupData` |
