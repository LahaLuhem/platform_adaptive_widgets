...
| `showPlatformDialog<T>()`                                          | `showDialog` + `Dialog`                       | `showCupertinoDialog`                                                                                        | `MaterialDialogData`                                  |
| `showPlatformFullscreenDialog<T>()`                                | `showDialog` + `Dialog.fullscreen`            | `showCupertinoDialog` (no native iOS fullscreen-dialog concept)                                              | `MaterialFullscreenDialogData`                        |
...
| `showPlatformModalBottomSheet<T>()`                                | `showModalBottomSheet`                        | `showCupertinoModalPopup`                                                                                    | `MaterialModalBottomSheetData`, `CupertinoModalPopupData` |
...
| `PlatformCheckbox`         | `Checkbox`                                                                                     | `CupertinoCheckbox`                                                                                  | `MaterialCheckboxData`, `CupertinoCheckboxData`                                                      |
