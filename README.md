...
| Model                      | Description                                                                                                                                                                                              |
|----------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| `Date`, `Month`, `Weekday` | Calendar value types taken by `showPlatformDatePicker`. Re-exported from [`minted_chronology`](https://pub.dev/packages/minted_chronology), which refuses impossible dates instead of rolling them over. |
